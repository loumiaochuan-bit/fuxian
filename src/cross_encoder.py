...
class BertClause(BertPreTrainedModel):
    ...
    def __init__(self, config,co_hidden_size=768, co_intermediate_size=1536, clause_max_len=None, max_len=None):
        ...
        config.co_num_attention_heads = config.num_attention_heads
        self.config = config
        ...
        self.src_dropout = nn.Dropout(self.config.hidden_dropout_prob)
        ...
        # coattention layer
        self.config.num_connection_layers = 1
